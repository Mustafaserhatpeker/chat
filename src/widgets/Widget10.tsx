    ...
    return (
        <div className="fixed bottom-6 right-6 flex flex-col items-end gap-3 z-50">
            ...
            <AnimatePresence>
                {!open && proactiveVisible && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: 10 }}
                        className="relative bg-white rounded-2xl rounded-br-sm shadow-xl border border-indigo-100 px-4 py-3 max-w-52"
                    >
                        <p className="text-sm font-semibold text-gray-800">
                            <Sparkles size={13} className="inline mr-1 text-indigo-400" />
                            Yakın yörüngedeyim...
                        </p>
                        <p className="text-xs text-gray-400 mt-1">{greeting} Yörüngenizdeyim 🪐</p>
                        <button
                            onClick={dismiss}
            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className="w-80 rounded-2xl shadow-2xl overflow-hidden bg-white border border-indigo-100"
                    >
                        {/* Header */}
                        ...
                        {/* Messages */}
                        <div className="px-4 py-4 flex flex-col gap-3 bg-indigo-50 min-h-36">
                        ...
                        <div className="px-3 py-3 border-t bg-white flex items-center gap-2">
                            <input
                                className="flex-1 text-sm outline-none px-3 py-2 rounded-full bg-indigo-50 placeholder:text-indigo-300"
            ...
            <motion.button
                ...
                className="w-16 h-16 bg-linear-to-br from-indigo-900 to-purple-900 rounded-full flex items-center justify-center shadow-lg overflow-hidden"
            >
